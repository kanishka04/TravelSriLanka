        ...
        <div class="box">
            <div class="content">
                ...
                <div class ="container-fluid">
                    ...
                    <br/>
                    <div >
                        <p id ="idasd" style="color: #0b0b0b; margin-right: 5px;"> <?php echo $q['comment'];?>
                        </p>
                    </div>
                    <hr/>
<!--                    <input style=" margin-top:-4px; margin-bottom: 15px; margin-right:40px; float:right;" type ="button" id = "button2" value="Reply"/>-->
                ...
                <h1 style="alignment: center; margin-top: 100px;"><b>Please share your experience in Udawalawe with others</b></h1>
                <h1>Comments</h1>
                <form action="controller/Udawalawesrilanka.php" method="post">
