...
<!--                    <input style=" margin-top:-4px; margin-bottom: 15px; margin-right:40px; float:right;" type ="button" id = "button2" value="Reply"/>-->
                ...
                <?php }?>
                <h1 style="alignment: center; margin-top: 100px;"><b>Please share your experience in Anuradhapura with others</b></h1>
                <h1>Comments</h1>
                <form action="controller/Anuradhapura.php" method="post">
